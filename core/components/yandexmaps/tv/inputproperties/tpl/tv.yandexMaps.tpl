...
MODx.load({
    ...
    ,items: [{
        ...
        xtype: 'textfield'
        ,fieldLabel: '{/literal}{$ymlex.admin_coords}{literal}'
        ,description: MODx.expandHelp ? '' : '{/literal}{$ymlex.admin_coords_desc}{literal}'
        ...
        ,html: '{/literal}{$ymlex.admin_coords_desc}{literal}'
        ,cls: 'desc-under'
    },{
        xtype: 'textfield'
        ,fieldLabel: '{/literal}{$ymlex.admin_zoom}{literal}'
        ,description: MODx.expandHelp ? '' : '{/literal}{$ymlex.admin_zoom_desc}{literal}'
        ...
        ,html: '{/literal}{$ymlex.admin_zoom_desc}{literal}'
        ,cls: 'desc-under'
    }]
